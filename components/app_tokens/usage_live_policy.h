...
/* The quota pages' live header. Which jobs count as active is decided by
 * tk_agent_monitor_effective_state (agent_monitor_policy.h), the one
 * freshness rule for agent states; this only counts and words them. */
